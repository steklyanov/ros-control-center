...
"""autogenerated by genpy from backend/OrderAction.msg. Do not edit."""
import sys
...
class OrderAction(genpy.Message):
  _md5sum = "61307efb2b8922ab3704bf39e690cb2d"
  _type = "backend/OrderAction"
...
"""
  ...
  _slot_types = ['backend/OrderActionGoal','backend/OrderActionResult','backend/OrderActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrderAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = backend.msg.OrderActionGoal()
      if self.action_result is None:
        self.action_result = backend.msg.OrderActionResult()
      if self.action_feedback is None:
        self.action_feedback = backend.msg.OrderActionFeedback()
    else:
      self.action_goal = backend.msg.OrderActionGoal()
      self.action_result = backend.msg.OrderActionResult()
      self.action_feedback = backend.msg.OrderActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_h().pack(self.action_goal.goal.order_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.order_id,) = _get_struct_h().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
