...
"""autogenerated by genpy from backend/OrderActionFeedback.msg. Do not edit."""
import sys
...
class OrderActionFeedback(genpy.Message):
  _md5sum = "82e97615735594b25e2cee3da22d3eb7"
  _type = "backend/OrderActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','backend/OrderFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrderActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = backend.msg.OrderFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = backend.msg.OrderFeedback()
