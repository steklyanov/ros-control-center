...
"""autogenerated by genpy from backend/ReviewActionResult.msg. Do not edit."""
import sys
...
class ReviewActionResult(genpy.Message):
  _md5sum = "fafe5a625efea970ce1a33bf0723ccde"
  _type = "backend/ReviewActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','backend/ReviewResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ReviewActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = backend.msg.ReviewResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = backend.msg.ReviewResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_b().pack(self.result.review))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.review,) = _get_struct_b().unpack(str[start:end])
      return self
