...
"""autogenerated by genpy from backend/PinCodeAction.msg. Do not edit."""
import sys
...
class PinCodeAction(genpy.Message):
  _md5sum = "2f247abcf56fed3130ce005c8d38512f"
  _type = "backend/PinCodeAction"
...
"""
  ...
  _slot_types = ['backend/PinCodeActionGoal','backend/PinCodeActionResult','backend/PinCodeActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PinCodeAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = backend.msg.PinCodeActionGoal()
      if self.action_result is None:
        self.action_result = backend.msg.PinCodeActionResult()
      if self.action_feedback is None:
        self.action_feedback = backend.msg.PinCodeActionFeedback()
    else:
      self.action_goal = backend.msg.PinCodeActionGoal()
      self.action_result = backend.msg.PinCodeActionResult()
      self.action_feedback = backend.msg.PinCodeActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.pin_code
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.pin_message
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.pin_code = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.pin_code = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.pin_message = str[start:end].decode('utf-8')
      else:
        self.action_result.result.pin_message = str[start:end]
      _x = self
      start = end
      end += 12
