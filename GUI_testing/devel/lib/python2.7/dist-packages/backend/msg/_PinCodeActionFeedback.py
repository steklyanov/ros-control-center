...
"""autogenerated by genpy from backend/PinCodeActionFeedback.msg. Do not edit."""
import sys
...
class PinCodeActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "backend/PinCodeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','backend/PinCodeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PinCodeActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = backend.msg.PinCodeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = backend.msg.PinCodeFeedback()
