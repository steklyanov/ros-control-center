...
"""autogenerated by genpy from backend/OrderActionResult.msg. Do not edit."""
import sys
...
class OrderActionResult(genpy.Message):
  _md5sum = "bab5bf1bf26d47208c3532f492261478"
  _type = "backend/OrderActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','backend/OrderResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrderActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = backend.msg.OrderResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = backend.msg.OrderResult()
