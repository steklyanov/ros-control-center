...
"""autogenerated by genpy from backend/PinCodeActionResult.msg. Do not edit."""
import sys
...
class PinCodeActionResult(genpy.Message):
  _md5sum = "9bbe2ca10a2740c65f9b5d6e1c75b955"
  _type = "backend/PinCodeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','backend/PinCodeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PinCodeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = backend.msg.PinCodeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = backend.msg.PinCodeResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.pin_message = str[start:end].decode('utf-8')
      else:
        self.result.pin_message = str[start:end]
      return self
