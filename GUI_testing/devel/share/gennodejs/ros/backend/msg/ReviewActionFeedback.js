...
let ReviewFeedback = require('./ReviewFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ReviewActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ReviewFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ReviewActionFeedback(null);
    ...
    data.feedback = ReviewFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReviewActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ReviewFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ReviewFeedback()
    }
...
module.exports = ReviewActionFeedback;
