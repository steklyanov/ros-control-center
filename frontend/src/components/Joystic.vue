...
<script>
    ...
    export default {
        name: "joystic",
        methods: {
          // createJoystick(manager, joystickContainer, cmdVel, twist) {
          ...
          //         this.moveAction(lin, ang, cmdVel, twist);
          //         setTimeout(function () {
          ...
          //       this.moveAction(0, 0, cmdVel, twist);
          //     });
          //   }
          // },

          init_var() {
            function moveAction(linear, angular, cmdVel, twist)
            {
            ...
            // this.createJoystick(manager, joysctickContainer, cmdVel, twist)
            ...
            if (manager == null) {
              ...
              manager.on('move', function (evt, nipple) {
                ...
                if (publishImmidiately) {
                  publishImmidiately = false;
                  moveAction(lin, ang, cmdVel, twist);
                  setTimeout(function () {
                    publishImmidiately = true;
                  }, 50);
                }
